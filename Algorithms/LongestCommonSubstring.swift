...
//    static func longestCommonSubstring(_ s1: String, _ s2: String) -> String {
//
//        var memo: [[String?]] = Array(
//            repeating: Array(
//                repeating: .none,
//                count: s2.count
//            ),
...
//        )
//
//        func helper(_ s1: String, _ s2: String, _ i1: Int, _ i2: Int, memo: inout [[String?]]) -> String {
//
...
//            }
//
//            let stringIndex1 = s1.index(s1.startIndex, offsetBy: i1)
//            let stringIndex2 = s2.index(s2.startIndex, offsetBy: i2)
//            let stringAtIndex1 = s1[stringIndex1]
//            let stringAtIndex2 = s2[stringIndex2]
//
//            if stringAtIndex1 == stringAtIndex2 {
//                memo[i1][i2] =  String(stringAtIndex1) + helper(s1, s2, i1 + 1, i2 + 1, memo: &memo)
//                return memo[i1][i2]!
//            }
//
